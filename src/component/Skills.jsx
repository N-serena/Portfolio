...
import { SiSpringboot, SiTailwindcss, SiGit, SiJavascript, SiPostman, SiJunit5 } from "react-icons/si";
...
const Skills = ({ theme }) => (
  ...
  <section id="skills" className="mx-4 md:mx-16 mb-12">
    ...
    <div className={`flex flex-wrap gap-8 items-center ${theme.text}`}>
      ...
      <div className="flex flex-col items-center">
        <SiJunit5 className="text-4xl text-[#25A162]" />
        <span className="mt-2 text-sm">JUnit 5</span>
      </div>
